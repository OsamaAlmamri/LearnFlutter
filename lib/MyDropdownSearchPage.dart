...
class MyDropdownSearchPage extends StatefulWidget {
  @override
  _MyDropdownSearchPageState createState() => _MyDropdownSearchPageState();
}

class _MyDropdownSearchPageState extends State<MyDropdownSearchPage> {
